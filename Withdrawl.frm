...
WithdrawlDate = Format(Now, "dd/mm/yyyy")
...
s2 = "insert into Trans(T_Type,Acc_No,DOT,Narration,Amount) values('" & WithdrawlType & "'," & AtmNumber.AccountNo & ",'" & WithdrawlDate & "','" & WithdrawlNarration & "'," & Val(Text1.Text) & ")"
...
WithdrawlType = "Withdrawl"
WithdrawlNarration = "-Debited"
End Sub
